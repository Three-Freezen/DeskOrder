...
// ── Image Crop Preview ──
        ...
        // Dialog title — derived per-kind by SavePresetDialog / LoadPresetDialog via $"Preset.SaveTitle.{Kind}".
        ["Preset.SaveTitle.Zone"]        = new() { [Language.Chinese] = "保存分区预设", [Language.English] = "Save Zone Preset" },
        ["Preset.SaveTitle.Clock"]       = new() { [Language.Chinese] = "保存时钟预设", [Language.English] = "Save Clock Preset" },
        ["Preset.SaveTitle.Calendar"]    = new() { [Language.Chinese] = "保存日历预设", [Language.English] = "Save Calendar Preset" },
        ["Preset.SaveTitle.StickyNote"]  = new() { [Language.Chinese] = "保存便签预设", [Language.English] = "Save Sticky Note Preset" },
        ["Preset.SaveTitle.MergedGroup"] = new() { [Language.Chinese] = "保存组合预设", [Language.English] = "Save Merged Group Preset" },
        ["Preset.SaveTitle.Panel"]       = new() { [Language.Chinese] = "保存面板预设", [Language.English] = "Save Panel Preset" },
        ["Preset.LoadTitle.Zone"]        = new() { [Language.Chinese] = "加载分区预设", [Language.English] = "Load Zone Preset" },
        ["Preset.LoadTitle.Clock"]       = new() { [Language.Chinese] = "加载时钟预设", [Language.English] = "Load Clock Preset" },
        ["Preset.LoadTitle.Calendar"]    = new() { [Language.Chinese] = "加载日历预设", [Language.English] = "Load Calendar Preset" },
        ["Preset.LoadTitle.StickyNote"]  = new() { [Language.Chinese] = "加载便签预设", [Language.English] = "Load Sticky Note Preset" },
        ["Preset.LoadTitle.MergedGroup"] = new() { [Language.Chinese] = "加载组合预设", [Language.English] = "Load Merged Group Preset" },
        ["Preset.LoadTitle.Panel"]       = new() { [Language.Chinese] = "加载面板预设", [Language.English] = "Load Panel Preset" },
